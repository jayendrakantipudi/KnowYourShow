    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tvshow.Season')),
                ('series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tvshow.TVShow')),
            ],
        ),
    ]
